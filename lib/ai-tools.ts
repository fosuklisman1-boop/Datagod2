...
const setMtnProviderTool: Anthropic.Tool = {
  ...
  input_schema: {
    type: "object" as const,
    properties: {
      provider: { type: "string", enum: ["sykes", "datakazina", "xpress", "eazyghdata", "bisdel", "codecraft", "agentportalgh"], description: "Provider to switch to. Omit to just read current setting." },
    },
    required: [],
  },
}
...
const syncFulfillmentStatusTool: Anthropic.Tool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      provider: { type: "string", enum: ["sykes", "datakazina", "xpress", "eazyghdata", "bisdel", "codecraft", "agentportalgh"], description: "Provider to sync from" },
    },
    required: [],
  },
}
