        ...
        <Tabs value={activeTab} onValueChange={v => setActiveTab(v as any)}>
          ...
          <TabsContent value="inventory" className="space-y-4 mt-4">
            ...
            <div className="flex gap-3 items-center">
              ...
              <span className="text-sm text-muted-foreground ml-auto">{inventoryTotal} total</span>
            </div>
            ...
            <div className="rounded-lg border overflow-hidden">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y">
                  {inventoryLoading ? (
                    <tr><td colSpan={8} className="px-4 py-8 text-center text-muted-foreground"><Loader2 className="w-5 h-5 animate-spin mx-auto" /></td></tr>
                  ) : inventoryItems.length === 0 ? (
                    <tr><td colSpan={8} className="px-4 py-8 text-center text-muted-foreground">No vouchers found</td></tr>
                    ...
                    <tr key={item.id} className="hover:bg-accent">
                      ...
                      <td className="px-4 py-3 text-muted-foreground text-xs">{item.batch_id ?? "—"}</td>
                      <td className="px-4 py-3 text-muted-foreground text-xs">{item.expiry_date ?? "—"}</td>
                  ...
                  <div>
                    ...
                    <div className="rounded-lg border overflow-hidden">
                      <table className="w-full text-xs">
                        {uploadMode === "text" ? (
                          <>
                            <thead className="bg-muted/40"><tr>{["#","Board","PIN","Serial"].map(h => <th key={h} className="px-3 py-2 text-left text-muted-foreground">{h}</th>)}</tr></thead>
                            <tbody className="divide-y">
                          ...
                          <>
                            <thead className="bg-muted/40"><tr>{["PIN","Serial","Expiry","Notes"].map(h => <th key={h} className="px-3 py-2 text-left text-muted-foreground">{h}</th>)}</tr></thead>
                            <tbody className="divide-y">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                  ...
                  return (
                    <div key={board} className="space-y-3 pb-4 border-b last:border-0">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label className="text-xs text-muted-foreground">Base Price (GHS)</Label>
                        ...
                        <div>
                          <Label className="text-xs text-muted-foreground">Max Shop Markup (GHS per voucher)</Label>
                          <Input type="number" step="0.01" min="0"
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div>
                    <Label className="text-xs text-muted-foreground">Max Vouchers Per Order</Label>
                  ...
                  <div>
                    <Label className="text-xs text-muted-foreground">Reservation Timeout (minutes)</Label>
                    <Input type="number" min="1"
