...
DROP POLICY IF EXISTS "Shop owners can read their own ussd_shop_codes" ON ussd_shop_codes;
CREATE POLICY "Shop owners can read their own ussd_shop_codes"
  ON ussd_shop_codes FOR SELECT
  USING (
    shop_id IN (
