...
export function AIChatWidget({ shop, shopSlug, onCheckoutPrefill }: Props) {
  ...
  return (
    <div ref={wrapperRef} className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {isOpen && (
        <div className="w-[calc(100vw-3rem)] sm:w-[360px] h-[520px] max-h-[calc(100vh-100px)] bg-white/70 backdrop-blur-2xl rounded-2xl shadow-2xl shadow-violet-500/10 border border-white/40 flex flex-col overflow-hidden">
